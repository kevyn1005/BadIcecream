...
/**
 * Muro vertical que ocupa 1 celda
 * Se usa en los bordes izquierdo y derecho
 */
public class VerticalWall implements Wall {
    ...
    public VerticalWall(int gridX, int gridY, GridSystem grid, String imagePath) {
    ...
    private Image loadSprite(String path) {
        try {
            ...
            if (icon.getIconWidth() > 0) {
                ...
                System.out.println("Advertencia: No se pudo cargar muro vertical: " + path);
            }
        } catch (Exception e) {
            System.out.println("Error cargando muro vertical: " + path);
        }
        return null;
    }
